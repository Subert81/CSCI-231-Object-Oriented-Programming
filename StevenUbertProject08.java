 ...
 *
 * There are a total of 512 possiblilities, so you can use decimal numbers 0, 1, 2, 3,...., 511
 * to represent all the states of the matrix.
 * 
...
public class "Name Goes Here!"Project08
{
   public static void main (String[] args)
   {
     //the multi-dimentional matrix array
        ...
        System.out.print("Enter an integer representing the state of the coins Heads or Tails: ");
